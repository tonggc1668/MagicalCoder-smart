...
/**
 * Created by www.magicalcoder.com on 14-7-2.
 * 799374340@qq.com
 */
public class XssHtmlFilter {
    ...
    public XssHtmlFilter()
    {
        ...
        this.vAllowed.put("div", no_atts);
        this.vAllowed.put("p", no_atts);
        this.vAllowed.put("u", no_atts);
        this.vAllowed.put("strike", no_atts);
        this.vAllowed.put("span", no_atts);
        this.vAllowed.put("br",no_atts);
        this.vSelfClosingTags = new String[] { "img" ,"br"};
        this.vNeedClosingTags = new String[] { "a", "b", "strong", "i", "em","div","p","u","strike","span" };
        this.vDisallowed = new String[0];
        this.vAllowedProtocols = new String[] { "http", "mailto" };
        this.vProtocolAtts = new String[] { "src", "href" };
        this.vRemoveBlanks = new String[] { "a", "b", "strong", "i", "em","div","p","u","strike","span" };
    ...
    public XssHtmlFilter(boolean debug)
    {
        this();
        this.vDebug = debug;
    }

    public XssHtmlFilter(Map<String, Object> conf)
    {
...
//            Logger.getAnonymousLogger().info(msg);
    ...
    public boolean isContainXss(String input){
        reset();
        String s = input;
        return !s.equals(escapeComments(s)) || !s.equals(balanceHTML(s))
                || !s.equals(checkTags(s)) || !s.equals(processRemoveBlanks(s))
                || !s.equals(validateEntities(s));
    }

    public static void main(String[] args) {
        XssHtmlFilter f = new XssHtmlFilter();
    }
