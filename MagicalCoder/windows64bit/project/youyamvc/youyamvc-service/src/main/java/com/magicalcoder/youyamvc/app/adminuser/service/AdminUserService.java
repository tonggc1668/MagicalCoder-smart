...
public interface AdminUserService{
    ...
    * @return
    */
    AdminUser selectOneAdminUserWillThrowException(Map<String, Object> query);
    ...
    */
    void updateAdminUserByWhereSql(Map<String,Object> entity,String whereSql);
    ...
    */
    void deleteAdminUserList(Map<String,Object> entity);

    /**
    * 根据自定义条件删除实体
    * @param whereSql not blank  有sql注入风险 请开发人员自行保证安全性
    */
    void deleteAdminUserByWhereSql(String whereSql);
    ...
    * @param idList
    */
    void batchDeleteAdminUser(List<Long> idList);
    /**
    * 根据主键list 批量删除实体
    ...
    * @return
    */
    void transactionImportJsonList(List<AdminUser> list);
    ...
    */
    List<AdminUser> tryQueryList(String keyword,String selectValue, String foreignJavaField);
}
