package com.magicalcoder.youyamvc.app.modulecategory.service;
...
public interface ModuleCategoryService{
    ...
    * @return
    */
    ModuleCategory getModuleCategory(Long id);
    ...
    * @return
    */
    ModuleCategory selectOneModuleCategoryWillThrowException(Map<String, Object> query);
    ...
    */
    void updateModuleCategoryByWhereSql(Map<String,Object> entity,String whereSql);

    /**
    * 根据主键删除实体
    * @param id
    */
    void deleteModuleCategory(Long id);
    /**
    * 删除实体集合
    * @param entity 如果字段值不为空 将作为查询条件
    */
    void deleteModuleCategoryList(Map<String,Object> entity);

    /**
    * 根据自定义条件删除实体
    * @param whereSql not blank  有sql注入风险 请开发人员自行保证安全性
    */
    void deleteModuleCategoryByWhereSql(String whereSql);
    ...
    * @param idList
    */
    void batchDeleteModuleCategory(List<Long> idList);
    /**
    * 根据主键list 批量删除实体
    ...
    * @return
    */
    void transactionImportJsonList(List<ModuleCategory> list);
    ...
    */
    List<ModuleCategory> tryQueryList(String keyword,String selectValue, String foreignJavaField);
}
