...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
        <section class="content-header">
            <h1>
                模块分类列表 
                <a class="btn btn-app" href="admin/module_category/detail"><i class="fa fa-edit"></i>新增</a>
            </h1>
            <ol class="breadcrumb">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                                 ...
                                                 <div class="form-group">
                                                     <label for="moduleCategoryNameFirst">模块名称 (like)</label>
                                                     <input type="text" class="form-control"
                                                      value="${ moduleCategoryNameFirst }"
                                                                                                    id="moduleCategoryNameFirst" name="moduleCategoryNameFirst">
                                                 </div>
                                             </div>
                                                <div class="col-xs-2">
                                                    <div class="form-group">
                        ...
                        <div class="box-body table-responsive" style="overflow: auto">
                            <div class="row">
                                <div class="form-horizontal" >
                                    <div class="col-sm-1">
                                        <input type="button" onclick="batchDeleteItem('module_category')" value="删除选中项">
                                    </div>
                                </div>
                                <div class="form-horizontal" >
                                    <div class="col-sm-1">
                                        <input type="button" class="form-control" onclick="truncateTable('module_category')" value="清空数据">
                                    </div>
                                </div>
                                <div class="form-horizontal" >
                                ...
                                <div class="form-horizontal" >
                                    ...
                                    <div class="col-sm-1">
                                        <input type="file" id="importJsonFile" class="form-control"
                                               name="myfiles" onchange="importJsonFile('admin/module_category/import/json')"/>
                                    </div>
                                </div>
                            </div>
                            <table id="example2" class="table table-bordered table-hover dataTable">
                                <thead id="thead">
                                              <tr>
                                                  ...
                                                  <th>序号</th>
                                                 <th  class="sorting" orderField="module_category_name">                                                      模块名称
                                                  </th>
...
<script src="assets/admin/app/modulecategory/moduleCategoryPaging.js" type="text/javascript"></script>
