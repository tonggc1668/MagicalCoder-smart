                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-primary">
                            <form class="form-horizontal" role="form" id="form" action="admin/role/save" method="post">
                                <div class="box-header">
                                    <h3 class="box-title">
                                        <c:choose><c:when test="${role.id==null}">新增</c:when><c:otherwise>编辑</c:otherwise></c:choose>
                                    </h3>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control " id="roleName"
                                                   name="roleName" title="角色名"  placeholder="请输入角色名"
                                                             value="${role.roleName}">
                                        </div>
