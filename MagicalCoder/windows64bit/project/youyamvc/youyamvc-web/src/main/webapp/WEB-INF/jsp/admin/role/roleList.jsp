...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
        <section class="content-header">
            <h1>
                角色列表 
                <a class="btn btn-app" href="admin/role/detail"><i class="fa fa-edit"></i>新增</a>
            </h1>
            <ol class="breadcrumb">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                                 ...
                                                 <div class="form-group">
                                                     <label for="roleNameFirst">角色名 (like)</label>
                                                     <input type="text" class="form-control"
                                                      value="${ roleNameFirst }"
                                                                                                    id="roleNameFirst" name="roleNameFirst">
                                                 </div>
                                             </div>
                                                <div class="col-xs-2">
                                                    <div class="form-group">
                        ...
                        <div class="box-body table-responsive" style="overflow: auto">
                            <div class="row">
                                <div class="form-horizontal" >
                                    <div class="col-sm-1">
                                        <input type="button" onclick="batchDeleteItem('role')" value="删除选中项">
                                    </div>
                                </div>
                                <div class="form-horizontal" >
                                    <div class="col-sm-1">
                                        <input type="button" class="form-control" onclick="truncateTable('role')" value="清空数据">
                                    </div>
                                </div>
                                <div class="form-horizontal" >
                                ...
                                <div class="form-horizontal" >
                                    ...
                                    <div class="col-sm-1">
                                        <input type="file" id="importJsonFile" class="form-control"
                                               name="myfiles" onchange="importJsonFile('admin/role/import/json')"/>
                                    </div>
                                </div>
                            </div>
                            <table id="example2" class="table table-bordered table-hover dataTable">
                                <thead id="thead">
                                              <tr>
                                                  ...
                                                  <th>序号</th>
                                                 <th  class="sorting" orderField="role_name">                                                      角色名
                                                  </th>
                                                  <th>操作</th>
                                              </tr>
                                </thead>
...
<script src="assets/admin/app/role/rolePaging.js" type="text/javascript"></script>
