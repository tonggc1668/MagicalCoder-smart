                    ...
                    <div class="box">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                                 ...
                                                 <div class="form-group">
                                                     <label for="userNameFirst">登录名称 (=)</label>
                                                 ...
                                                 <div class="col-xs-2">
                                                 <div class="form-group">
                                                 <label for="registTimeFirst"> 注册时间 (=)</label>
                                                 <input  type="text"
                                                  ...
                                                  onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'%y-%M-%d %H:%m:%s'})"
                                                      value="<c:out value='${ registTimeFirst }' escapeXml="false"/>"
                                                  id="registTimeFirst" name="registTimeFirst">
                                                 </div>
                                                 </div>
                                                <div class="col-xs-2">
                                                    <div class="form-group">
                        ...
                        <div class="box-body table-responsive" style="overflow: auto">
                            <div class="row">
                                ...
                                <div class="form-horizontal" >
                                    <div class="col-sm-1">
                                        <input type="button" class="form-control" onclick="truncateTable('user_web')" value="清空数据">
                                    </div>
                                </div>
                                <div class="form-horizontal" >
                                ...
                                <div class="form-horizontal" >
                                    ...
                                    <div class="col-sm-1">
                                        <input type="file" id="importJsonFile" class="form-control"
                                               name="myfiles" onchange="importJsonFile('admin/user_web/import/json')"/>
                                    </div>
                                </div>
                            </div>
